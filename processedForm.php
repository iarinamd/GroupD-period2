                            ...
                            if (strlen($_FILES["photo1"]["name"]) < 50 && preg_match('/[A-Z]/', $_FILES["photo1"]["name"])) {
                                if ($_FILES["photo1"]["size"] < $fileSize) {
                                    ...
                                    if (in_array($uploadedFileType, $acceptedTypes)) {
                                        if (!file_exists("img/uploads/" . $_FILES["photo1"]["name"])) {
                                            if(move_uploaded_file($_FILES["photo1"]["tmp_name"], "uploads/". $_FILES["photo1"]["name"])) {
                                                $photo1 = "img/uploads/". $_FILES["photo1"]["name"];
